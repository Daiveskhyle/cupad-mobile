...
const [refreshing,setRefreshing]=useState(false);
 ...
 const allowedMax=(r:Row)=>Math.max(0,Math.min(2,Number(settings.max_installments_per_payment)||2,remainingInstallments(r)||2));
